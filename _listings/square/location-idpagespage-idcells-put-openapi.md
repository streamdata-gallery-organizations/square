...
paths:
  ...
  /{location_id}/fees/{fee_id}:
    ...
    delete:
      ...
      x-api-path-slug: location-idfeesfee-id-delete
      parameters:
      - in: path
        name: fee_id
  ...
  /{location_id}/items/{item_id}/fees/{fee_id}:
    put:
      ...
      x-api-path-slug: location-iditemsitem-idfeesfee-id-put
      parameters:
      - in: path
        name: fee_id
    ...
    delete:
      ...
      x-api-path-slug: location-iditemsitem-idfeesfee-id-delete
      parameters:
      - in: path
        name: fee_id
        description: The ID of the fee to apply
